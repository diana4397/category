          ...
          <div className="user d-inline-block">
            <UncontrolledDropdown className="dropdown-menu-right">
              <DropdownToggle className="p-0" color="empty">
                <span className="name mr-1">{this.state.user.first_name +" "+ this.state.user.last_name}</span>
                <span>
              ...
              <DropdownMenu className="mt-3" right>
                ...
                <DropdownItem>History</DropdownItem>*/}
                  <DropdownItem onClick={()=>this.handlePasswordChange()}>Change Password</DropdownItem>
                <DropdownItem divider /> 
                 <DropdownItem onClick={()=>this.handleProfile()}>Profile</DropdownItem>
                <DropdownItem divider /> 
